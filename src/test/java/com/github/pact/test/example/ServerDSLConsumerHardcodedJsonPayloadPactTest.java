...
public class ServerDSLConsumerHardcodedJsonPayloadPactTest {
	...
	private static final String HARDCODED_PAYLOAD_BAD_PRACTICE_BUT_CAN_BE_USED_ONLY_FOR_SPEED = "{\"someData\":{\"mir\":\"hello world\"}}";
	...
	public RequestResponsePact articlesFragment(PactDslWithProvider builder) {
		return builder.given(DESCRIPTION_AND_JIRA_TICKET).uponReceiving("retrieving article data")
				...
				.body(HARDCODED_PAYLOAD_BAD_PRACTICE_BUT_CAN_BE_USED_ONLY_FOR_SPEED).toPact();
	}
	...
	public void testArticles() throws IOException {
		...
		assertEquals(HARDCODED_PAYLOAD_BAD_PRACTICE_BUT_CAN_BE_USED_ONLY_FOR_SPEED, result.toString());
	}
